...
import com.zhkj.sfb.adapter.CityAdapter;
...
public class CityActivity extends BasetActivity {
    ...
    public class CityTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if(cityPojos!=null && cityPojos.size()>0){
                ...
                CityAdapter cityAdapter = new CityAdapter(CityActivity.this,cityPojos,areaView,flag);

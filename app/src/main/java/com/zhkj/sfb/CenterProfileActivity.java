...
public class CenterProfileActivity extends BasetActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //实例化WebView对象
        webView = (WebView)findViewById(R.id.center_webview);
        //设置WebView属性，能够执行Javascript脚本
        webView.getSettings().setJavaScriptEnabled(true);
        //设置打开的页面地址
        webView.loadUrl("http://shifei.yungoux.com/res/html/"+areaId+"_introduction.html");

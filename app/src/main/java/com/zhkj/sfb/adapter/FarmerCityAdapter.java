 ...
 */
public class FarmerCityAdapter extends RecyclerView.Adapter<FarmerCityAdapter.ViewHolder> {
    ...
    public FarmerCityAdapter(Context context, List<CityPojo> cityPojos, RecyclerView areaView, RecyclerView townshipView, RecyclerView villageView, int flag)
    {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int i)
    {
        ...
        viewHolder.nameView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                townshipView.setVisibility(View.GONE);
                new Thread(){
                    @Override
                    public void run() {
                        super.run();
    ...
    public class AreaTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if(areaPojos!=null && areaPojos.size()>0){
                ...
                FarmerAreaAdapter areaAdapter = new FarmerAreaAdapter(mContext,areaPojos,townshipView,villageView,flag);
        ...
        protected String doInBackground(Void... param) {
            try {
                areaPojos = new ArrayList<AreaPojo>();
